...
class RequestOutput:
    ...
    def add(self, next_output: "RequestOutput", aggregate: bool) -> None:
        ...
        if next_output.acceptance_lengths is not None:
            self.acceptance_lengths = next_output.acceptance_lengths
            ...
            for i, completion in enumerate(self.outputs):
                if completion.index == next_completion.index:
                    if aggregate:
                        ...
                        if not isinstance(
                            completion.token_ids, MutableSequence
                        ):
    ...
    def from_seq_group(
        ...
        if seq_group.acceptance_lengths:
            init_kwargs["acceptance_lengths"] = seq_group.acceptance_lengths
...
class PoolingRequestOutput(Generic[_O]):
    ...
    def from_seq_group(seq_group: SequenceGroup) -> "PoolingRequestOutput":
        ...
        return PoolingRequestOutput(
            seq_group.request_id, output, prompt_token_ids, finished
        )
