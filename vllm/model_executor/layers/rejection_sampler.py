...
class RejectionSampler(SpecDecodeStochasticBaseSampler):
    ...
    def __init__(
        self, strict_mode: bool = False, use_flashinfer: Optional[bool] = None
    ):
    ...
    def forward(
        ...
        request_ids: Optional[List[str]] = None,  # Add this parameter
    ) -> torch.Tensor:
        ...
        if self.use_flashinfer and chain_speculative_sampling is not None:
            ...
            output_token_ids = self._create_output(
                ...
                draft_token_ids,
                bonus_token_ids,
                request_ids,  # Pass request_ids here
            )
    ...
    def _batch_modified_rejection_sampling(
        ...
        accepted = self._get_accepted(
            target_probs, draft_probs, draft_token_ids, seeded_seqs
        )
