...
class RequestOutputCollector:
    ...
    def __init__(self, output_kind: RequestOutputKind):
        ...
        self.output: Optional[
            Union[RequestOutput, PoolingRequestOutput, Exception]
        ] = None
...
class RequestState:
    def __init__(
        ...
        self.acceptance_lengths: list[int] = []

        self.stats = (
            RequestStateStats(arrival_time=arrival_time) if log_stats else None
        )
...
class OutputProcessor:
    ...
    def process_outputs(
        ...
        request_outputs: Union[
            list[RequestOutput], list[PoolingRequestOutput]
        ] = []
        reqs_to_abort: list[str] = []
        for engine_core_output in engine_core_outputs:
            ...
            if engine_core_output.acceptance_length is not None:
                req_state.acceptance_lengths.append(
                    engine_core_output.acceptance_length
                )
