...
def create_common_attn_metadata(
    ...
    seq_lens = torch.tensor(
        batch_spec.seq_lens, dtype=torch.int32, device=device
    )
...
def get_attention_backend(backend_name: _Backend):
    ...
    backend_map = {
        ...
        _Backend.XFORMERS_VLLM_V1: "vllm.v1.attention.backends.xformers.XFormersAttentionBackend",
    }
